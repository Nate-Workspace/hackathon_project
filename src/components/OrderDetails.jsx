...
function OrderDetails() {
  ...
  return (
    <div className="ml-60 w-screen">
      <h1 className="text-3xl text-green-600 font-bold mb-8 mt-8 ml-60">
        Order Status
      </h1>
      <div className="flex items-center justify-center space-x-4 ml-60">
        <button
        ...
        >
          {orderDetails.map((orderItem) => (
            <div
              key={orderItem.id}
              className="w-64 border border-gray-300 rounded-lg p-2 mb-4 hover:shadow-lg transition duration-300"
            >
              <div className="flex flex-col items-center">
                <div className="w-60 h-32 overflow-hidden mb-2">
                  <img
                    src={orderItem.image}
                    alt={orderItem.title}
                ...
                <button className="border-2 border-green-500 rounded-lg px-4 py-1 mt-2 focus:outline-none hover:bg-green-500 hover:text-white ">
                  Delivered
                </button>
              </div>
            </div>
